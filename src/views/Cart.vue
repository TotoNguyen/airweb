  ...
  <section class="cart">
    <main>
      <h1 class="text-black-text text-xl flex mb-8">
        ...
        <span class="ml-4">Votre panier</span>
      </h1>
    ...
    <footer class="flex justify-end">
      <button-elt v-if="cart.length > 0" class="uppercase mr-0 ml-auto">Procéder au paiement</button-elt>
    </footer>
  </section>
</template>
...
<style scoped>
.cart {
  @apply w-1/2 m-auto text-gray-title;
}
</style>